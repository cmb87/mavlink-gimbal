...
static void mavlink_test_uwb_swarm_sensor(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_UWB_SWARM_SENSOR >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_uwb_swarm_sensor_t packet1, packet2;
        ...
        packet1.pitch = packet_in.pitch;
        packet1.yaw = packet_in.yaw;
        packet1.RXQuality = packet_in.RXQuality;
        packet1.RXPower = packet_in.RXPower;
        packet1.RXFPPower = packet_in.RXFPPower;
        packet1.id = packet_in.id;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_UWB_SWARM_SENSOR_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_UWB_SWARM_SENSOR_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uwb_swarm_sensor_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_uwb_swarm_sensor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uwb_swarm_sensor_pack(system_id, component_id, &msg , packet1.usec , packet1.id , packet1.d , packet1.x , packet1.y , packet1.z , packet1.vx , packet1.vy , packet1.vz , packet1.roll , packet1.pitch , packet1.yaw , packet1.RXQuality , packet1.RXPower , packet1.RXFPPower );
    mavlink_msg_uwb_swarm_sensor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uwb_swarm_sensor_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.usec , packet1.id , packet1.d , packet1.x , packet1.y , packet1.z , packet1.vx , packet1.vy , packet1.vz , packet1.roll , packet1.pitch , packet1.yaw , packet1.RXQuality , packet1.RXPower , packet1.RXFPPower );
    mavlink_msg_uwb_swarm_sensor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_uwb_swarm_sensor_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uwb_swarm_sensor_send(MAVLINK_COMM_1 , packet1.usec , packet1.id , packet1.d , packet1.x , packet1.y , packet1.z , packet1.vx , packet1.vy , packet1.vz , packet1.roll , packet1.pitch , packet1.yaw , packet1.RXQuality , packet1.RXPower , packet1.RXFPPower );
    mavlink_msg_uwb_swarm_sensor_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("UWB_SWARM_SENSOR") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_UWB_SWARM_SENSOR) != NULL);
#endif
}

static void mavlink_test_uwb_swarm_formation(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_UWB_SWARM_FORMATION >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_uwb_swarm_formation_t packet_in = {
        93372036854775807ULL,73.0,101.0,129.0,157.0,185.0,213.0,101,168
    };
    mavlink_uwb_swarm_formation_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.usec = packet_in.usec;
        packet1.x = packet_in.x;
        packet1.y = packet_in.y;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_UWB_SWARM_FORMATION_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_UWB_SWARM_FORMATION_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uwb_swarm_formation_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_uwb_swarm_formation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uwb_swarm_formation_pack(system_id, component_id, &msg , packet1.usec , packet1.id , packet1.x , packet1.y , packet1.z , packet1.roll , packet1.pitch , packet1.yaw , packet1.formation_type );
    mavlink_msg_uwb_swarm_formation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uwb_swarm_formation_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.usec , packet1.id , packet1.x , packet1.y , packet1.z , packet1.roll , packet1.pitch , packet1.yaw , packet1.formation_type );
    mavlink_msg_uwb_swarm_formation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_uwb_swarm_formation_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uwb_swarm_formation_send(MAVLINK_COMM_1 , packet1.usec , packet1.id , packet1.x , packet1.y , packet1.z , packet1.roll , packet1.pitch , packet1.yaw , packet1.formation_type );
    mavlink_msg_uwb_swarm_formation_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("UWB_SWARM_FORMATION") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_UWB_SWARM_FORMATION) != NULL);
#endif
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_uwb_swarm_sensor(system_id, component_id, last_msg);
    mavlink_test_uwb_swarm_formation(system_id, component_id, last_msg);
